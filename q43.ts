...
let magiciansName: string [] = ["David Copperfield", "David Blaine", "Harry Houdini", "Penn & Teller"];
let copy_magiciansName: string [] = (JSON.parse(JSON.stringify(magiciansName))).sort();
...
function copy_show_magicians(copy_magician_name: string) {
    return `${copy_magician_name}`
}

console.log(`------------------------------`);

function copy_make_great(copy_magician_name: string) {
